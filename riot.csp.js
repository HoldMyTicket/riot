...
(function (global, factory) {
  ...
  function Primitives (context) {
    ...
    if (this instanceof Primitives) {
      ...
      for (var i = 0; i < names.length; i++) {
        if (!this$1$1.context[names[i]]) {
          this$1$1.context[names[i]] = wrap(primitives[i]);
        }
      }
    } else {
  	...
  	var CommentHandler = (function () {
  	    ...
  	    CommentHandler.prototype.insertInnerComments = function (node, metadata) {
  	        ...
  	        if (node.type === syntax_1.Syntax.BlockStatement && node.body.length === 0) {
  	            ...
  	            for (var i = this.leading.length - 1; i >= 0; --i) {
  	                var entry = this$1$1.leading[i];
  	                if (metadata.end.offset >= entry.start) {
  	                    innerComments.unshift(entry.comment);
  	                    this$1$1.leading.splice(i, 1);
  	                    this$1$1.trailing.splice(i, 1);
  	                }
  	            }
  	    ...
  	    CommentHandler.prototype.findTrailingComments = function (node, metadata) {
  	        ...
  	        if (this.trailing.length > 0) {
  	            for (var i = this.trailing.length - 1; i >= 0; --i) {
  	                var entry_1 = this$1$1.trailing[i];
  	    ...
  	    CommentHandler.prototype.findLeadingComments = function (node, metadata) {
  	        ...
  	        while (this.stack.length > 0) {
  	            var entry = this$1$1.stack[this$1$1.stack.length - 1];
  	            if (entry && entry.start >= metadata.start.offset) {
  	                target = this$1$1.stack.pop().node;
  	            }
  	            else {
  	                break;
  	            }
  	...
  	var Parser = (function () {
  	            ...
  	            if (comments.length > 0 && this.delegate) {
  	                for (var i = 0; i < comments.length; ++i) {
  	                    ...
  	                    node = {
  	                        ...
  	                        value: this$1$1.scanner.source.slice(e.slice[0], e.slice[1])
  	                    };
  	                    if (this$1$1.config.range) {
  	                        node.range = e.range;
  	                    }
  	                    if (this$1$1.config.loc) {
  	                        node.loc = e.loc;
  	                    }
  	                    var metadata = {
  	                        start: {
  	                    ...
  	                    this$1$1.delegate(node, metadata);
  	                }
  	            }
  	        }
  	    };
  	    ...
  	    Parser.prototype.parseArrayInitializer = function () {
  	        ...
  	        while (!this.match(']')) {
  	            ...
  	            else if (this$1$1.match('...')) {
  	                var element = this$1$1.parseSpreadElement();
  	                if (!this$1$1.match(']')) {
  	                    this$1$1.context.isAssignmentTarget = false;
  	                    this$1$1.context.isBindingElement = false;
  	                    this$1$1.expect(',');
  	                }
  	                elements.push(element);
  	            }
  	            else {
  	                elements.push(this$1$1.inheritCoverGrammar(this$1$1.parseAssignmentExpression));
  	                if (!this$1$1.match(']')) {
  	                    this$1$1.expect(',');
  	                }
  	            }
  	    ...
  	    Parser.prototype.parseObjectInitializer = function () {
  	        ...
  	        while (!this.match('}')) {
  	            properties.push(this$1$1.parseObjectProperty(hasProto));
  	            if (!this$1$1.match('}')) {
  	                this$1$1.expectCommaSeparator();
  	            }
  	        }
  	        this.expect('}');
  	    ...
  	    Parser.prototype.parseTemplateLiteral = function () {
  	        ...
  	        quasis.push(quasi);
  	        while (!quasi.tail) {
  	            expressions.push(this$1$1.parseExpression());
  	            quasi = this$1$1.parseTemplateElement();
  	            quasis.push(quasi);
  	        }
  	        ...
  	        switch (expr.type) {
  	            ...
  	            case syntax_1.Syntax.ArrayExpression:
  	                ...
  	                for (var i = 0; i < expr.elements.length; i++) {
  	                    if (expr.elements[i] !== null) {
  	                        this$1$1.reinterpretExpressionAsPattern(expr.elements[i]);
  	                    }
  	                }
  	                break;
  	            case syntax_1.Syntax.ObjectExpression:
  	                ...
  	                for (var i = 0; i < expr.properties.length; i++) {
  	                    this$1$1.reinterpretExpressionAsPattern(expr.properties[i].value);
  	                }
  	                break;
  	            ...
  	            if (this.match('...')) {
  	                ...
  	                if (this.match(',')) {
  	                    ...
  	                    while (this.startMarker.index < this.scanner.length) {
  	                        ...
  	                        this$1$1.nextToken();
  	                        if (this$1$1.match('...')) {
  	                            if (!this$1$1.context.isBindingElement) {
  	                                this$1$1.throwUnexpectedToken(this$1$1.lookahead);
  	                            }
  	                            expressions.push(this$1$1.parseRestElement(params));
  	                            this$1$1.expect(')');
  	                            if (!this$1$1.match('=>')) {
  	                                this$1$1.expect('=>');
  	                            }
  	                            ...
  	                            for (var i = 0; i < expressions.length; i++) {
  	                                this$1$1.reinterpretExpressionAsPattern(expressions[i]);
  	                            }
  	                            arrow = true;
  	                            expr = {
  	                                type: ArrowParameterPlaceHolder,
  	                            ...
  	                            expressions.push(this$1$1.inheritCoverGrammar(this$1$1.parseAssignmentExpression));
  	                        }
  	                        if (arrow) {
  	                            break;
  	                        }
  	                        ...
  	                        if (!arrow) {
  	                            ...
  	                            if (expr.type === syntax_1.Syntax.SequenceExpression) {
  	                                for (var i = 0; i < expr.expressions.length; i++) {
  	                                    this$1$1.reinterpretExpressionAsPattern(expr.expressions[i]);
  	                                }
  	                            }
  	                            else {
  	    ...
  	    Parser.prototype.parseArguments = function () {
  	        ...
  	        if (!this.match(')')) {
  	            while (true) {
  	                var expr = this$1$1.match('...') ? this$1$1.parseSpreadElement() :
  	                    this$1$1.isolateCoverGrammar(this$1$1.parseAssignmentExpression);
  	                args.push(expr);
  	                if (this$1$1.match(')')) {
  	                    break;
  	                }
  	    ...
  	    Parser.prototype.parseLeftHandSideExpressionAllowCall = function () {
  	        ...
  	        while (true) {
  	            if (this$1$1.match('.')) {
  	                this$1$1.context.isBindingElement = false;
  	                this$1$1.context.isAssignmentTarget = true;
  	                this$1$1.expect('.');
  	                var property = this$1$1.parseIdentifierName();
  	                expr = this$1$1.finalize(this$1$1.startNode(startToken), new Node.StaticMemberExpression(expr, property));
  	            }
  	            else if (this$1$1.match('(')) {
  	                this$1$1.context.isBindingElement = false;
  	                this$1$1.context.isAssignmentTarget = false;
  	                var args = this$1$1.parseArguments();
  	                expr = this$1$1.finalize(this$1$1.startNode(startToken), new Node.CallExpression(expr, args));
  	            }
  	            else if (this$1$1.match('[')) {
  	                this$1$1.context.isBindingElement = false;
  	                this$1$1.context.isAssignmentTarget = true;
  	                this$1$1.expect('[');
  	                var property = this$1$1.isolateCoverGrammar(this$1$1.parseExpression);
  	                this$1$1.expect(']');
  	                expr = this$1$1.finalize(this$1$1.startNode(startToken), new Node.ComputedMemberExpression(expr, property));
  	            }
  	            else if (this$1$1.lookahead.type === token_1.Token.Template && this$1$1.lookahead.head) {
  	                var quasi = this$1$1.parseTemplateLiteral();
  	                expr = this$1$1.finalize(this$1$1.startNode(startToken), new Node.TaggedTemplateExpression(expr, quasi));
  	            }
  	            else {
  	                break;
  	            }
  	    ...
  	    Parser.prototype.parseLeftHandSideExpression = function () {
  	        ...
  	        while (true) {
  	            if (this$1$1.match('[')) {
  	                ...
  	                var property = this$1$1.isolateCoverGrammar(this$1$1.parseExpression);
  	                this$1$1.expect(']');
  	                expr = this$1$1.finalize(node, new Node.ComputedMemberExpression(expr, property));
  	            }
  	            else if (this$1$1.match('.')) {
  	                this$1$1.context.isBindingElement = false;
  	                this$1$1.context.isAssignmentTarget = true;
  	                this$1$1.expect('.');
  	                var property = this$1$1.parseIdentifierName();
  	                expr = this$1$1.finalize(node, new Node.StaticMemberExpression(expr, property));
  	            }
  	            else if (this$1$1.lookahead.type === token_1.Token.Template && this$1$1.lookahead.head) {
  	                var quasi = this$1$1.parseTemplateLiteral();
  	                expr = this$1$1.finalize(node, new Node.TaggedTemplateExpression(expr, quasi));
  	            }
  	            else {
  	                break;
  	            }
  	    ...
  	    Parser.prototype.parseBinaryExpression = function () {
  	        ...
  	        if (prec > 0) {
  	            ...
  	            while (true) {
  	                prec = this$1$1.binaryPrecedence(this$1$1.lookahead);
  	                if (prec <= 0) {
  	                    break;
  	                }
  	                ...
  	                while ((stack.length > 2) && (prec <= stack[stack.length - 2].prec)) {
  	                    ...
  	                    left = stack.pop();
  	                    markers.pop();
  	                    var node = this$1$1.startNode(markers[markers.length - 1]);
  	                    stack.push(this$1$1.finalize(node, new Node.BinaryExpression(operator, left, right)));
  	                }
  	                // Shift.
  	                token = this$1$1.nextToken();
  	                token.prec = prec;
  	                stack.push(token);
  	                markers.push(this$1$1.lookahead);
  	                stack.push(this$1$1.isolateCoverGrammar(this$1$1.parseExponentiationExpression));
  	            }
  	            ...
  	            markers.pop();
  	            while (i > 1) {
  	                var node = this$1$1.startNode(markers.pop());
  	                expr = this$1$1.finalize(node, new Node.BinaryExpression(stack[i - 1].value, stack[i - 2], expr));
  	                i -= 2;
  	            }
  	        }
  	        return expr;
  	        ...
  	        switch (param.type) {
  	            ...
  	            case syntax_1.Syntax.ArrayPattern:
  	                for (var i = 0; i < param.elements.length; i++) {
  	                    if (param.elements[i] !== null) {
  	                        this$1$1.checkPatternParam(options, param.elements[i]);
  	                    }
  	                }
  	                break;
  	            ...
  	            default:
  	                ...
  	                for (var i = 0; i < param.properties.length; i++) {
  	                    this$1$1.checkPatternParam(options, param.properties[i].value);
  	                }
  	                break;
  	        }
  	    };
  	    Parser.prototype.reinterpretAsCoverFormalsList = function (expr) {
  	        ...
  	        for (var i = 0; i < params.length; ++i) {
  	            ...
  	            this$1$1.checkPatternParam(options, param);
  	            params[i] = param;
  	        }
  	    ...
  	    Parser.prototype.parseExpression = function () {
  	        ...
  	        if (this.match(',')) {
  	            ...
  	            while (this.startMarker.index < this.scanner.length) {
  	                ...
  	                this$1$1.nextToken();
  	                expressions.push(this$1$1.isolateCoverGrammar(this$1$1.parseAssignmentExpression));
  	            }
  	            expr = this.finalize(this.startNode(startToken), new Node.SequenceExpression(expressions));
  	        }
  	        return expr;
  	    ...
  	    Parser.prototype.parseBlock = function () {
  	        ...
  	        while (true) {
  	            ...
  	            block.push(this$1$1.parseStatementListItem());
  	        }
  	        this.expect('}');
  	    ...
  	    Parser.prototype.parseBindingList = function (kind, options) {
  	        ...
  	        while (this.match(',')) {
  	            this$1$1.nextToken();
  	            list.push(this$1$1.parseLexicalBinding(kind, options));
  	        }
  	        return list;
  	    };
  	    ...
  	    Parser.prototype.parseArrayPattern = function (params, kind) {
  	        ...
  	        while (!this.match(']')) {
  	            if (this$1$1.match(',')) {
  	                ...
  	                if (this$1$1.match('...')) {
  	                    elements.push(this$1$1.parseBindingRestElement(params, kind));
  	                    break;
  	                }
  	                else {
  	                    elements.push(this$1$1.parsePatternWithDefault(params, kind));
  	                }
  	                if (!this$1$1.match(']')) {
  	                    this$1$1.expect(',');
  	                }
  	    ...
  	    Parser.prototype.parseObjectPattern = function (params, kind) {
  	        ...
  	        this.expect('{');
  	        while (!this.match('}')) {
  	            properties.push(this$1$1.parsePropertyPattern(params, kind));
  	            if (!this$1$1.match('}')) {
  	                this$1$1.expect(',');
  	            }
  	        }
  	    ...
  	    Parser.prototype.parseVariableDeclarationList = function (options) {
  	        ...
  	        while (this.match(',')) {
  	            this$1$1.nextToken();
  	            list.push(this$1$1.parseVariableDeclaration(opt));
  	        }
  	        return list;
  	    };
  	            ...
  	            if (this.matchKeyword('var')) {
  	                ...
  	                if (this.matchKeyword('in')) {
  	                    ...
  	                    if (this.match(',')) {
  	                        ...
  	                        while (this.match(',')) {
  	                            this$1$1.nextToken();
  	                            initSeq.push(this$1$1.isolateCoverGrammar(this$1$1.parseAssignmentExpression));
  	                        }
  	    ...
  	    Parser.prototype.parseSwitchCase = function () {
  	        ...
  	        var consequent = [];
  	        while (true) {
  	            if (this$1$1.match('}') || this$1$1.matchKeyword('default') || this$1$1.matchKeyword('case')) {
  	                break;
  	            }
  	            consequent.push(this$1$1.parseStatementListItem());
  	        }
  	    ...
  	    Parser.prototype.parseSwitchStatement = function () {
  	        ...
  	        while (true) {
  	            ...
  	            var clause = this$1$1.parseSwitchCase();
  	            if (clause.test === null) {
  	                if (defaultFound) {
  	                    this$1$1.throwError(messages_1.Messages.MultipleDefaultsInSwitch);
  	                }
  	                defaultFound = true;
  	            }
  	            cases.push(clause);
  	    ...
  	    Parser.prototype.parseCatchClause = function () {
  	        ...
  	        for (var i = 0; i < params.length; i++) {
  	            ...
  	            if (Object.prototype.hasOwnProperty.call(paramMap, key)) {
  	                this$1$1.tolerateError(messages_1.Messages.DuplicateBinding, params[i].value);
  	            }
  	            paramMap[key] = true;
  	        }
  	    ...
  	    Parser.prototype.parseFunctionSourceElements = function () {
  	        ...
  	        while (this.startMarker.index < this.scanner.length) {
  	            ...
  	            body.push(this$1$1.parseStatementListItem());
  	        }
  	        this.expect('}');
  	    ...
  	    Parser.prototype.parseFormalParameter = function (options) {
  	        ...
  	        for (var i = 0; i < params.length; i++) {
  	            this$1$1.validateParam(options, params[i], params[i].value);
  	        }
  	    ...
  	    Parser.prototype.parseFormalParameters = function (firstRestricted) {
  	        ...
  	        if (!this.match(')')) {
  	            options.paramSet = {};
  	            while (this.startMarker.index < this.scanner.length) {
  	                if (!this$1$1.parseFormalParameter(options)) {
  	                    break;
  	                }
  	                this$1$1.expect(',');
  	            }
  	    ...
  	    Parser.prototype.parseDirectivePrologues = function () {
  	        ...
  	        var body = [];
  	        while (true) {
  	            var token = this$1$1.lookahead;
  	            if (token.type !== token_1.Token.StringLiteral) {
  	                break;
  	            }
  	            var statement = this$1$1.parseDirective();
  	            body.push(statement);
  	            ...
  	            if (directive === 'use strict') {
  	                this$1$1.context.strict = true;
  	                if (firstRestricted) {
  	                    this$1$1.tolerateUnexpectedToken(firstRestricted, messages_1.Messages.StrictOctalLiteral);
  	                }
  	            }
  	            else {
  	    ...
  	    Parser.prototype.parseClassElementList = function () {
  	        ...
  	        while (!this.match('}')) {
  	            if (this$1$1.match(';')) {
  	                ...
  	                body.push(this$1$1.parseClassElement(hasConstructor));
  	            }
  	        }
  	        this.expect('}');
  	        return body;
  	    ...
  	    Parser.prototype.parseNamedImports = function () {
  	        ...
  	        var specifiers = [];
  	        while (!this.match('}')) {
  	            specifiers.push(this$1$1.parseImportSpecifier());
  	            if (!this$1$1.match('}')) {
  	                this$1$1.expect(',');
  	            }
  	        }
  	    ...
  	    Parser.prototype.parseExportDeclaration = function () {
  	        ...
  	        if (this.matchKeyword('default')) {
  	            ...
  	            this.expect('{');
  	            while (!this.match('}')) {
  	                isExportFromIdentifier = isExportFromIdentifier || this$1$1.matchKeyword('default');
  	                specifiers.push(this$1$1.parseExportSpecifier());
  	                if (!this$1$1.match('}')) {
  	                    this$1$1.expect(',');
  	                }
  	            }
  ...
  /***/ function(module, exports, __webpack_require__) {
  	...
  	var Scanner = (function () {
  	    ...
  	    Scanner.prototype.skipSingleLineComment = function (offset) {
  	        ...
  	        while (!this.eof()) {
  	            var ch = this$1$1.source.charCodeAt(this$1$1.index);
  	            ++this$1$1.index;
  	            if (character_1.Character.isLineTerminator(ch)) {
  	                if (this$1$1.trackComment) {
  	                    loc.end = {
  	                        line: this$1$1.lineNumber,
  	                        column: this$1$1.index - this$1$1.lineStart - 1
  	                    };
  	                    var entry = {
  	                        multiLine: false,
  	                        slice: [start + offset, this$1$1.index - 1],
  	                        range: [start, this$1$1.index - 1],
  	                        loc: loc
  	                    };
  	                    comments.push(entry);
  	                }
  	                if (ch === 13 && this$1$1.source.charCodeAt(this$1$1.index) === 10) {
  	                    ++this$1$1.index;
  	                }
  	                ++this$1$1.lineNumber;
  	                this$1$1.lineStart = this$1$1.index;
  	                return comments;
  	            }
  	        }
  	        if (this.trackComment) {
  	    ...
  	    Scanner.prototype.skipMultiLineComment = function () {
  	        ...
  	        while (!this.eof()) {
  	            var ch = this$1$1.source.charCodeAt(this$1$1.index);
  	            if (character_1.Character.isLineTerminator(ch)) {
  	                if (ch === 0x0D && this$1$1.source.charCodeAt(this$1$1.index + 1) === 0x0A) {
  	                    ++this$1$1.index;
  	                }
  	                ++this$1$1.lineNumber;
  	                ++this$1$1.index;
  	                ...
  	                if (this$1$1.source.charCodeAt(this$1$1.index + 1) === 0x2F) {
  	                    this$1$1.index += 2;
  	                    if (this$1$1.trackComment) {
  	                        loc.end = {
  	                            line: this$1$1.lineNumber,
  	                            column: this$1$1.index - this$1$1.lineStart
  	                        };
  	                        var entry = {
  	                            multiLine: true,
  	                            slice: [start + 2, this$1$1.index - 2],
  	                            range: [start, this$1$1.index],
  	                            loc: loc
  	                        };
  	                        comments.push(entry);
  	                    }
  	    ...
  	    Scanner.prototype.scanComments = function () {
  	        ...
  	        while (!this.eof()) {
  	            ...
  	            if (character_1.Character.isWhiteSpace(ch)) {
  	                ...
  	                ++this$1$1.index;
  	                if (ch === 0x0D && this$1$1.source.charCodeAt(this$1$1.index) === 0x0A) {
  	                    ++this$1$1.index;
  	                }
  	                ++this$1$1.lineNumber;
  	                this$1$1.lineStart = this$1$1.index;
  	                ...
  	                ch = this$1$1.source.charCodeAt(this$1$1.index + 1);
  	                if (ch === 0x2F) {
  	                    this$1$1.index += 2;
  	                    var comment = this$1$1.skipSingleLineComment(2);
  	                    if (this$1$1.trackComment) {
  	                    ...
  	                    this$1$1.index += 2;
  	                    var comment = this$1$1.skipMultiLineComment();
  	                    if (this$1$1.trackComment) {
  	                        comments = comments.concat(comment);
  	                    }
  	                }
  	                ...
  	                // U+003E is '>'
  	                if ((this$1$1.source.charCodeAt(this$1$1.index + 1) === 0x2D) && (this$1$1.source.charCodeAt(this$1$1.index + 2) === 0x3E)) {
  	                    // '-->' is a single-line comment
  	                    this$1$1.index += 3;
  	                    var comment = this$1$1.skipSingleLineComment(3);
  	                    if (this$1$1.trackComment) {
  	                        comments = comments.concat(comment);
  	                    }
  	                }
  	                ...
  	                if (this$1$1.source.slice(this$1$1.index + 1, this$1$1.index + 4) === '!--') {
  	                    this$1$1.index += 4; // `<!--`
  	                    var comment = this$1$1.skipSingleLineComment(4);
  	                    if (this$1$1.trackComment) {
  	                        comments = comments.concat(comment);
  	                    }
  	                }
  	    ...
  	    Scanner.prototype.scanHexEscape = function (prefix) {
  	        ...
  	        var code = 0;
  	        for (var i = 0; i < len; ++i) {
  	            if (!this$1$1.eof() && character_1.Character.isHexDigit(this$1$1.source.charCodeAt(this$1$1.index))) {
  	                code = code * 16 + hexValue(this$1$1.source[this$1$1.index++]);
  	            }
  	            else {
  	                return '';
  	            }
  	    ...
  	    Scanner.prototype.scanUnicodeCodePointEscape = function () {
  	        ...
  	        while (!this.eof()) {
  	            ch = this$1$1.source[this$1$1.index++];
  	    ...
  	    Scanner.prototype.getIdentifier = function () {
  	        ...
  	        while (!this.eof()) {
  	            ...
  	            if (ch === 0x5C) {
  	                ...
  	                this$1$1.index = start;
  	                return this$1$1.getComplexIdentifier();
  	            }
  	    ...
  	    Scanner.prototype.getComplexIdentifier = function () {
  	        ...
  	        while (!this.eof()) {
  	            cp = this$1$1.codePointAt(this$1$1.index);
  	            if (!character_1.Character.isIdentifierPart(cp)) {
  	                break;
  	            }
  	            ch = character_1.Character.fromCodePoint(cp);
  	            id += ch;
  	            this$1$1.index += ch.length;
  	            // '\u' (U+005C, U+0075) denotes an escaped character.
  	            if (cp === 0x5C) {
  	                id = id.substr(0, id.length - 1);
  	                if (this$1$1.source.charCodeAt(this$1$1.index) !== 0x75) {
  	                    this$1$1.throwUnexpectedToken();
  	                }
  	                ++this$1$1.index;
  	                if (this$1$1.source[this$1$1.index] === '{') {
  	                    ++this$1$1.index;
  	                    ch = this$1$1.scanUnicodeCodePointEscape();
  	                }
  	                else {
  	                    ch = this$1$1.scanHexEscape('u');
  	                    cp = ch.charCodeAt(0);
  	    ...
  	    Scanner.prototype.scanHexLiteral = function (start) {
  	        ...
  	        var number = '';
  	        while (!this.eof()) {
  	            if (!character_1.Character.isHexDigit(this$1$1.source.charCodeAt(this$1$1.index))) {
  	                break;
  	            }
  	            number += this$1$1.source[this$1$1.index++];
  	        }
  	        if (number.length === 0) {
  	            this.throwUnexpectedToken();
  	        }
  	    ...
  	    Scanner.prototype.scanOctalLiteral = function (prefix, start) {
  	        ...
  	        while (!this.eof()) {
  	            if (!character_1.Character.isOctalDigit(this$1$1.source.charCodeAt(this$1$1.index))) {
  	                break;
  	            }
  	            number += this$1$1.source[this$1$1.index++];
  	        }
  	    ...
  	    Scanner.prototype.scanStringLiteral = function () {
  	        ...
  	        var str = '';
  	        while (!this.eof()) {
  	            var ch = this$1$1.source[this$1$1.index++];
  	            if (ch === quote) {
  	                quote = '';
  	                break;
  	            }
  	                ...
  	                if (!ch || !character_1.Character.isLineTerminator(ch.charCodeAt(0))) {
  	                    switch (ch) {
  	                        ...
  	                        case 'x':
  	                            if (this$1$1.source[this$1$1.index] === '{') {
  	                                ++this$1$1.index;
  	                                str += this$1$1.scanUnicodeCodePointEscape();
  	                            }
  	                            else {
  	                                var unescaped = this$1$1.scanHexEscape(ch);
  	                                if (!unescaped) {
  	                                    this$1$1.throwUnexpectedToken();
  	                                }
  	                                str += unescaped;
  	                        ...
  	                        case '9':
  	                            str += ch;
  	                            this$1$1.tolerateUnexpectedToken();
  	                            break;
  	                        default:
  	                            if (ch && character_1.Character.isOctalDigit(ch.charCodeAt(0))) {
  	                                var octToDec = this$1$1.octalToDecimal(ch);
  	                    ...
  	                    ++this$1$1.lineNumber;
  	                    if (ch === '\r' && this$1$1.source[this$1$1.index] === '\n') {
  	                        ++this$1$1.index;
  	                    }
  	                    this$1$1.lineStart = this$1$1.index;
  	                }
  	                ...
  	                if (!character_1.Character.isLineTerminator(ch.charCodeAt(0))) {
  	                    switch (ch) {
  	                        ...
  	                        case 'x':
  	                            if (this$1$1.source[this$1$1.index] === '{') {
  	                                ++this$1$1.index;
  	                                cooked += this$1$1.scanUnicodeCodePointEscape();
  	                            }
  	                            else {
  	                                var restore = this$1$1.index;
  	                                var unescaped = this$1$1.scanHexEscape(ch);
  	                                if (unescaped) {
  	                                    cooked += unescaped;
  	                                }
  	                                else {
  	                                    this$1$1.index = restore;
  	                                    cooked += ch;
  	                                }
  	                            }
  	                            break;
  	                        ...
  	                        default:
  	                            if (ch === '0') {
  	                                if (character_1.Character.isDecimalDigit(this$1$1.source.charCodeAt(this$1$1.index))) {
  	                                    // Illegal: \01 \02 and so on
  	                                    this$1$1.throwUnexpectedToken(messages_1.Messages.TemplateOctalLiteral);
  	                                }
  	                                cooked += '\0';
  	                            }
  	    ...
  	    Scanner.prototype.scanRegExpBody = function () {
  	        ...
  	        while (!this.eof()) {
  	            ...
  	            if (ch === '\\') {
  	                ...
  	                // ECMA-262 7.8.5
  	                if (character_1.Character.isLineTerminator(ch.charCodeAt(0))) {
  	                    this$1$1.throwUnexpectedToken(messages_1.Messages.UnterminatedRegExp);
  	                }
  	                str += ch;
  	            }
  	            else if (character_1.Character.isLineTerminator(ch.charCodeAt(0))) {
  	...
  	var JSXParser = (function (_super) {
  	    ...
  	    JSXParser.prototype.scanXHTMLEntity = function (quote) {
  	        ...
  	        while (!this.scanner.eof() && valid && !terminated) {
  	            var ch = this$1$1.scanner.source[this$1$1.scanner.index];
  	            if (ch === quote) {
  	                break;
  	            }
  	            terminated = (ch === ';');
  	            result += ch;
  	            ++this$1$1.scanner.index;
  	            if (!terminated) {
  	    ...
  	    JSXParser.prototype.lexJSX = function () {
  	        ...
  	        if (cp === 34 || cp === 39) {
  	            ...
  	            while (!this.scanner.eof()) {
  	                ...
  	                if (ch === quote) {
  	                    ...
  	                    str += this$1$1.scanXHTMLEntity(quote);
  	                }
  	                else {
  	                    str += ch;
  	                }
  	        ...
  	        if (character_1.Character.isIdentifierStart(cp) && (cp !== 92)) {
  	            ...
  	            ++this.scanner.index;
  	            while (!this.scanner.eof()) {
  	                var ch = this$1$1.scanner.source.charCodeAt(this$1$1.scanner.index);
  	    ...
  	    JSXParser.prototype.nextJSXText = function () {
  	        ...
  	        while (!this.scanner.eof()) {
  	            ...
  	            text += ch;
  	            if (character_1.Character.isLineTerminator(ch.charCodeAt(0))) {
  	                ++this$1$1.scanner.lineNumber;
  	                if (ch === '\r' && this$1$1.scanner.source[this$1$1.scanner.index] === '\n') {
  	                    ++this$1$1.scanner.index;
  	                }
  	                this$1$1.scanner.lineStart = this$1$1.scanner.index;
  	            }
  	        }
  	        this.lastMarker.index = this.scanner.index;
  	        this.lastMarker.lineNumber = this.scanner.lineNumber;
  	    ...
  	    JSXParser.prototype.parseJSXElementName = function () {
  	        ...
  	        if (this.matchJSX(':')) {
  	            ...
  	            while (this.matchJSX('.')) {
  	                ...
  	                this$1$1.expectJSX('.');
  	                var property = this$1$1.parseJSXIdentifier();
  	                elementName = this$1$1.finalize(node, new JSXNode.JSXMemberExpression(object, property));
  	            }
  	        }
  	        return elementName;
  	    };
  	    ...
  	    JSXParser.prototype.parseJSXAttributes = function () {
  	        ...
  	        while (!this.matchJSX('/') && !this.matchJSX('>')) {
  	            var attribute = this$1$1.matchJSX('{') ? this$1$1.parseJSXSpreadAttribute() :
  	                this$1$1.parseJSXNameValueAttribute();
  	    ...
  	    JSXParser.prototype.parseJSXChildren = function () {
  	        ...
  	        var children = [];
  	        while (!this.scanner.eof()) {
  	            var node = this$1$1.createJSXChildNode();
  	            var token = this$1$1.nextJSXText();
  	            if (token.start < token.end) {
  	                var raw = this$1$1.getTokenRaw(token);
  	                var child = this$1$1.finalize(node, new JSXNode.JSXText(token.value, raw));
  	                children.push(child);
  	            }
  	            if (this$1$1.scanner.source[this$1$1.scanner.index] === '{') {
  	                var container = this$1$1.parseJSXExpressionContainer();
  	    ...
  	    JSXParser.prototype.parseComplexJSXElement = function (el) {
  	        ...
  	        var stack = [];
  	        while (!this.scanner.eof()) {
  	            el.children = el.children.concat(this$1$1.parseJSXChildren());
  	            var node = this$1$1.createJSXChildNode();
  	            var element = this$1$1.parseJSXBoundaryElement();
  	            if (element.type === jsx_syntax_1.JSXSyntax.JSXOpeningElement) {
  	                var opening = (element);
  	                if (opening.selfClosing) {
  	                    var child = this$1$1.finalize(node, new JSXNode.JSXElement(opening, [], null));
  	            ...
  	            if (element.type === jsx_syntax_1.JSXSyntax.JSXClosingElement) {
  	                ...
  	                if (open_1 !== close_1) {
  	                    this$1$1.tolerateError('Expected corresponding JSX closing tag for %0', open_1);
  	                }
  	                if (stack.length > 0) {
  	                    var child = this$1$1.finalize(el.node, new JSXNode.JSXElement(el.opening, el.children, el.closing));
  	                    el = stack.pop();
  	                    el.children.push(child);
  	                }
  	                else {
  	        ...
  	        if (this.buffer.length === 0) {
  	            ...
  	            if (this.scanner.trackComment) {
  	                for (var i = 0; i < comments.length; ++i) {
  	                    var e = comments[i];
  	                    var comment = void 0;
  	                    var value = this$1$1.scanner.source.slice(e.slice[0], e.slice[1]);
  	                    comment = {
  	                        type: e.multiLine ? 'BlockComment' : 'LineComment',
  	                        value: value
  	                    };
  	                    if (this$1$1.trackRange) {
  	                        comment.range = e.range;
  	                    }
  	                    if (this$1$1.trackLoc) {
  	                        comment.loc = e.loc;
  	                    }
  	                    this$1$1.buffer.push(comment);
  	                }
  	            }
  	            if (!this.scanner.eof()) {
  	                var loc = void 0;
  ...
  var s = extend(create(csp_tmpl_2.settings), {
  ...
  */
  ...
  function makeVirtual(src, target) {
    ...
    while (el) {
      sib = el.nextSibling;
      frag.appendChild(el);
      this$1$1.__.virts.push(el); // hold for unmounting
      el = sib;
    }
  ...
  function updateExpression(expr) {
    ...
    var keepValueAttributes = s.keepValueAttributes;
  ...
  function moveNestedTags(i) {
    ...
    each(Object.keys(this.tags), function (tagName) {
      moveChild.apply(this$1$1.tags[tagName], [tagName, i]);
    });
  }
  ...
  var IfExpr = {
    ...
    update: function update() {
      ...
      if (this.value) { update$2.call(this.tag, this.expressions); }
    },
    unmount: function unmount() {
      if (this.current) {
  ...
  function parseExpressions(root, mustIncludeRoot) {
    ...
    walkNodes(root, function (dom) {
      ...
      if (attr = getAttribute(dom, LOOP_DIRECTIVE)) {
        ...
        expressions.push(_each(dom, this$1$1, attr));
        return false
      }
      ...
      if (attr = getAttribute(dom, CONDITIONAL_DIRECTIVE)) {
        expressions.push(createIfDirective(dom, this$1$1, attr));
        return false
      }
      ...
      parseAttributes.apply(this$1$1, [dom, dom.attributes, function (attr, expr) {
        if (!expr) { return }
        expressions.push(expr);
      }]);
    });
  ...
  function parseAttributes(dom, attrs, fn) {
    ...
    each(attrs, function (attr) {
      ...
      if (contains(REF_DIRECTIVES, name) && dom.tagName.toLowerCase() !== YIELD_TAG) {
        expr =  createRefDirective(dom, this$1$1, name, attr.value);
  ...
  function componentMount(tag, dom, expressions, opts) {
    ...
    parseAttributes.apply(tag, [root, __.implAttrs, function (attr, expr) {
    ...
    each(parseExpressions.apply(tag, [dom, __.isAnonymous]), function (e) { return expressions.push(e); });
    ...
    if (!__.skipAnonymous && tag.parent) {
      var p = getImmediateCustomParent(tag.parent);
  ...
  function createTag(impl, conf, innerHTML) {
    ...
    var skipAnonymous = s.skipAnonymousTags && isAnonymous;
    var item = conf.item;
